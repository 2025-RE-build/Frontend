    ...
    <S.Background>
      ...
      <S.INPUT_Box>
        <S.Community_titleBOX>
          ...
          <S.Title_Box>"썸인 줄 알았는데 혼자였어요"</S.Title_Box>
        </S.Community_titleBOX>
        ...
        <S.Community_ContentBOX>
          ...
          <S.Content_Box>
            매일 톡하고, 서로 일상 공유하고, 잘 자라는 말까지 하길래 그냥… 나만
            그런 게 아니라고 생각했어요. 근데 알고 보니 걔는 원래 다정한
            성격이고, 나 혼자만 마음 키우고 있었더라고요. 친구한테 “걔 다른
            사람이랑 사귄대”라는 소식 듣고 멘붕… 1인 썸도 썸인가요? 😂
          </S.Content_Box>
        </S.Community_ContentBOX>
      </S.INPUT_Box>
